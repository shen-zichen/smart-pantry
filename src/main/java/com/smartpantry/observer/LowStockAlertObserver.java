...
/**
 * Logs a warning when a pantry item drops to or below its low-stock threshold. Keeps a history of
 * all alerts for later display or testing.
 */
@Component
public class LowStockAlertObserver implements IInventoryObserver {
  ...
  /**
   * Returns a copy of all alerts that have been fired. Useful for testing and for the View to
