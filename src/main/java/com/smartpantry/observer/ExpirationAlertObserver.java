...
/**
 * Logs a warning when a pantry item is approaching its expiration date. Keeps a history of all
 * alerts for later display or testing.
 */
@Component
public class ExpirationAlertObserver implements IInventoryObserver {
  ...
  public void onExpiringSoon(PantryItem item) {
    String message =
        "EXPIRING SOON: " + item.getName() + " — expires " + item.getExpirationDate() + "!";
